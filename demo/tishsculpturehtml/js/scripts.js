// Show the loadting effect before fetching data
document.getElementById("loadingAnimation").style.display = "block";

// Simulate fetching weather data
fetchWeatherData().then(() => {
  // Hide the animation after fetching data
...
jQuery(window).on("load", function() {
  /*********************************************
  *  THEME 1 Testimonial Slider
  **********************************************/
  var owl = jQuery('.theme1-slider');
  owl.owlCarousel({
  ...
  /*********************************************
  *  THEME 2 Testimonial Slider
  **********************************************/
  var owl = jQuery('.theme2-slider');
  owl.owlCarousel({
  ...
  /*********************************************
  *  THEME 3 Testimonial Slider
  **********************************************/
  var owl = jQuery('.theme3-slider');
  owl.owlCarousel({
    animateOut: 'fadeOut',
    animateIn: 'fadeIn',
    margin: 20,
  ...
  /*********************************************
  *  THEME 4 Testimonial Slider
  **********************************************/
  var owl = jQuery('.theme4-slider');
  owl.owlCarousel({
    animateOut: 'fadeOut',
    animateIn: 'fadeIn',
    margin: 10,
  ...
  /*********************************************
  *  THEME 5 Testimonial Slider
  **********************************************/
  var owl = jQuery('.theme5-slider');
  owl.owlCarousel({
    animateOut: 'fadeOut',
    animateIn: 'fadeIn',
    margin: 10,
...
document.addEventListener('scroll', function() {
  ...
  if (parallaxBackground) {
    // The speed factor (0.5 in this case) determines the parallax effect's speed
    var coords = '50% ' + (scrolled * 0.5) + 'px';
    parallaxBackground.style.backgroundPosition = coords;
  }
});
...
function equalizeHeights() {
    var wrappers = document.querySelectorAll('.tishonator-wrapper');

    if (!wrappers.length) return; // Exit if no elements found
...
window.onresize = function() {
    ...
    window.resizedFinished = setTimeout(equalizeHeights, 250);
};


document.addEventListener("DOMContentLoaded", function() {
    // Select all dropdown-toggle elements within .nav-barger-25
    var dropdownToggles = document.querySelectorAll('.nav-barger-25 .dropdown-toggle');
    ...
    dropdownToggles.forEach(function(toggle) {
        toggle.addEventListener('click', function(e) {
            ...
            var submenu = this.nextElementSibling; // The submenu is the next sibling element
            if (submenu) {
    ...
    // Select all menu item links within .nav-barger-25, including sub-menu items
    var menuItemLinks = document.querySelectorAll('.nav-barger-25 ul.main a');

    // Function to close the menu
    function closeMenu() {
        // Close all open submenus
        var openSubmenus = document.querySelectorAll('.nav-barger-25 .sub-menu');
        openSubmenus.forEach(function(submenu) {
            submenu.style.display = 'none';
        });

        // Here, add any other actions needed to close the menu, such as hiding the menu overlay, etc.
        $('.burger').toggleClass('clicked');
        $('.overlay').toggleClass('show');
        $('nav').toggleClass('show');
        $('body').toggleClass('overflow');
    ...
    menuItemLinks.forEach(function(link) {
        // Exclude dropdown-toggle links
        if (!link.classList.contains('dropdown-toggle')) {
            link.addEventListener('click', function() {
                closeMenu();
                // Follow the link. This will happen automatically as we are not preventing the default behavior.
            });
        }
    });
});
